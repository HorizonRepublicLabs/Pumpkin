...
for cmd in ["tp PumpkinBot 0 151 1",
            "setblock 0 150 -1 mekanism:osmium_ore",
            "setblock 1 150 -1 mekanism:block_steel",
            "setblock 2 150 -1 mekanism:energized_smelter",
            "setblock 3 150 -1 mysticalagriculture:prosperity_block",
            "give PumpkinBot mekanism:ingot_osmium 1"]:
...
print("\n".join(l for l in lines if any(k in l for k in
    ("mod dropped", "getDrops", "Changed", "ERROR", "Unimplemented", "Gave", "not loaded", "Unknown")))[-2500:])
