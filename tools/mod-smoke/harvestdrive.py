...
for cmd in ["setblock 0 149 -1 minecraft:farmland",
            "setblock 1 149 -1 minecraft:farmland",
            "setblock 0 150 -1 mysticalagriculture:inferium_crop[age=7]",
            "setblock 1 150 -1 mysticalagriculture:inferium_crop[age=3]",
...
print("\n".join(l for l in lines if any(k in l for k in
    ("mod dropped", "getDrops", "Changed the block", "ERROR", "Unimplemented")))[-2500:])
