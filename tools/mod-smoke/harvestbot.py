"""Joins, breaks two prepared crops (age 7 and age 3), idles briefly for pickups."""
    ...
    if state == "login" and pid == 2:
        ...
        if pid == 72:
            ...
            if not acted:
                acted = True
                def act():
                    time.sleep(10)  # let the setblocks land
                    seq = 1
                    for (x, y, z) in ((0, 150, -1), (1, 150, -1)):
                        # status 0 = start destroy; crops break instantly
