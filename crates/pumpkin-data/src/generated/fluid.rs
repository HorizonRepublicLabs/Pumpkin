...
pub const FLUID_STATES: &[PartialFluidState] = &[
    PartialFluidState {
        ...
        block_state_id: BlockStateId::new_base(0u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        block_state_id: BlockStateId::new_base(101u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(100u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(99u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(98u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(97u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(96u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(95u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(94u16).unwrap(),
        is_still: false,
        is_source: false,
        falling: false,
    },
    PartialFluidState {
        ...
        is_empty: false,
        blast_resistance: 100f32,
        block_state_id: BlockStateId::new_base(86u16).unwrap(),
        is_still: true,
        is_source: true,
        falling: false,
    },
    ...
    pub const FLOWING_WATER: Fluid = Fluid {
        ...
        states: &[
            ...
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(93u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(92u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(91u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(90u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(89u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(88u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(87u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
    ...
    pub const FLOWING_LAVA: Fluid = Fluid {
        ...
        states: &[
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(117u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(116u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(115u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(114u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(113u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(112u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(111u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(110u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(109u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(108u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(107u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(106u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(105u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(104u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(103u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new_base(102u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
