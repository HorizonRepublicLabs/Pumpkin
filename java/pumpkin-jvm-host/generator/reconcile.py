...
def commit():
    ...
    for pinned in PINNED:
        # The pinned copy is the source of truth, and installing it here is what makes
        # a hand edit to the live file disappear on the next regen. Edit both, always:
        # editing only the live file looks fine until a regen quietly undoes it.
...
edit('shim/src/main/java/dev/pumpkin/bridge/PumpkinLevel.java'.split('java/',1)[1], [
...
edit('net/neoforged/neoforge/transfer/energy/EnergyHandler.java', [
...
edit('net/minecraft/world/item/ItemInstance.java', [
...
edit('host/src/main/java/dev/pumpkin/jvmhost/Bootstrap.java'.split('java/',1)[1], [
...
edit('net/minecraft/world/level/material/FlowingFluid.java', [
...
edit('net/minecraft/world/level/material/Fluids.java', [
...
edit('net/minecraft/world/entity/EquipmentSlot.java', [
...
edit('net/minecraft/world/level/material/FluidState.java', [
...
edit('net/neoforged/neoforge/capabilities/BlockCapabilityCache.java', [
...
edit('dev/pumpkin/bridge/PumpkinValueIO.java', [
    ("            // A mod resource stack (Mekanism's LargeResourceStack and kin): a record of",
...
edit('net/minecraft/world/level/block/entity/FuelValues.java', [
...
edit('net/neoforged/neoforge/transfer/energy/EnergyHandlerUtil.java', [
...
edit('shim/src/main/java/dev/pumpkin/bridge/PumpkinBlockEntities.java'.split('java/',1)[1], [
    ('    public static BlockEntity getOrCreate(BlockEntityType<?> type, int x, int y, int z,\n            net.minecraft.world.level.block.state.BlockState state) {\n        return BY_POSITION.computeIfAbsent(key(x, y, z), ignored -> {\n            BlockEntity entity = type.pumpkinCreate(new BlockPos(x, y, z), state);\n            entity.pumpkinSetLevel(PumpkinInteractions.pumpkinLevel());\n            return entity;\n        });\n    }',
...
edit('net/neoforged/neoforge/common/extensions/ValueInputExtension.java', [
...
edit('net/minecraft/core/component/DataComponentGetter.java', [
...
edit('net/minecraft/world/item/Item.java', [
    ('        // Pumpkin divergence: real body. Item metadata Pumpkin does not model yet;\n\n        // accepted and dropped, chain returns `this`.\n\n        public <T> Item.Properties component(DataComponentType<T> type, T value) {\n\n            return this;\n\n        }',
     "        // Pumpkin divergence: the declared default components are recorded -- placed\n        // machines read their initial state (Mekanism's side configs) from them.\n        final java.util.LinkedHashMap<DataComponentType<?>, Object> pumpkinComponents =\n                new java.util.LinkedHashMap<>();\n\n        public <T> Item.Properties component(DataComponentType<T> type, T value) {\n            pumpkinComponents.put(type, value);\n            return this;\n        }"),
])

edit('net/minecraft/world/item/Item.java', [
    ('    public String pumpkinRegisteredId() {\n        return pumpkinRegisteredId;\n    }',
     '    public String pumpkinRegisteredId() {\n        return pumpkinRegisteredId;\n    }\n\n    // Pumpkin divergence: no vanilla counterpart -- the declared default components,\n    // for placed machines to read their initial state from.\n    public java.util.Map<net.minecraft.core.component.DataComponentType<?>, Object> pumpkinDefaultComponents() {\n        return pumpkinItemProperties == null ? java.util.Map.of()\n                : pumpkinItemProperties.pumpkinComponents;\n    }'),
])
...
edit('net/neoforged/neoforge/registries/DataPackRegistryEvent.java', [
...
edit('net/neoforged/neoforge/common/extensions/IBlockStateExtension.java', [
...
edit('net/neoforged/neoforge/common/extensions/TypedInstanceExtension.java', [
...
edit('net/neoforged/neoforge/common/util/NeoForgeExtraCodecs.java', [
...
edit('net/neoforged/neoforge/transfer/ResourceHandlerUtil.java', [
...
# ------------------------------------------------------ PacketDistributor
edit("net/neoforged/neoforge/network/PacketDistributor.java", [
