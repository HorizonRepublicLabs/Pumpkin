...
public class ClientboundContainerSetDataPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundContainerSetDataPacket(int containerId, int id, int value) {
        throw Unimplemented.forMember("net/minecraft/network/protocol/game/ClientboundContainerSetDataPacket.<init>:(III)V");
    }

    private ClientboundContainerSetDataPacket(FriendlyByteBuf input) {
        throw Unimplemented.forMember("net/minecraft/network/protocol/game/ClientboundContainerSetDataPacket.<init>:(Lnet/minecraft/network/FriendlyByteBuf;)V");
    }
