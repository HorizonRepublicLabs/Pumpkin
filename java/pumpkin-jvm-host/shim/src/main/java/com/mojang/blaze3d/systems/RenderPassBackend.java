...
public interface RenderPassBackend {
    ...
    void bindTexture(final String name, final GpuTextureView textureView, final GpuSampler sampler);
    ...
    void setVertexBuffer(final int slot, final GpuBufferSlice vertexBuffer);
    ...
    <T> void drawMultipleIndexed(final Collection<RenderPass.Draw<T>> draws, final GpuBuffer defaultIndexBuffer, final IndexType defaultIndexType, final Collection<String> dynamicUniforms, final T uniformArgument);
